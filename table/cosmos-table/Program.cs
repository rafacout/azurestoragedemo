...
namespace cosmos_table
{
    class Program
    {
        static string connection_string= "DefaultEndpointsProtocol=https;AccountName=storagedemo1001;AccountKey=YQVKvjLgVPz6EgjjXkLvdCO0lC2a8yRgbMk1rBZdVuMaCTJCzdZbNO/DIumQs6svOuLs/KsPt6vIlSl1cXtE7w==;EndpointSuffix=core.windows.net";
